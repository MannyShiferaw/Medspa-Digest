...
.site-header .brand-title { font-family: var(--font-display); font-style: italic; font-size: clamp(2rem, 4vw, 2.6rem); font-weight: 500; line-height: 1.08; margin: 0; text-wrap: balance; }
...
.subscribe-block { margin-bottom: 1.75rem; }
